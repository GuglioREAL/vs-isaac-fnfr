...
return {
	enter = function(self, from, songNum, songAppend)
		...
		train_passing = love.audio.newSource("sounds/week3/train.ogg", "static")
	...
	update = function(self, dt)
		...
		if song == 1 and musicThres ~= oldMusicThres and math.fmod(absMusicTime, 90000 * (love.math.random(17) + 7) / bpm) < 100 then
			train.x = train.x + (train.vx * dt) 
			audio.playSound(train_passing)
			girlfriend:animate("hair blowing", false)
		end
