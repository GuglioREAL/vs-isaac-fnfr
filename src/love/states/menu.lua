...
local funnyGuy = love.filesystem.load("sprites/menu/menuIdle.lua")()

local titleBG = graphics.newImage(love.graphics.newImage(graphics.imagePath("menu/title-bg")))

local note = graphics.newImage(love.graphics.newImage(graphics.imagePath("menu/Note")))
...
titleBG.sizeX, titleBG.sizeY = 0.8, 0.8
